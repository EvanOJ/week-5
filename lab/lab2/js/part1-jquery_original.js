...
$(document).ready(function() {
  ...
  //3 make ojbect of inputs
  // Write the code necessary to read from your input form and return a javascript object (with keys
  // to clarify the meaning of each value) that has all the data that's stored in your form.

  // THIS WAS MOVED TO PART 5
  // var userInputs = {
  //   textInput1:$('#text-input1').val(),
  //   textInput2:$('#text-input2').val(),
  //   textInput3:$('#text-input3').val(),
  //   numericInput:$('#numeric-input').val(),
  //   cboxInput1:$('#cbox-input1').prop('checked'),
  //   cboxInput2:$('#cbox-input2').prop('checked'),
...
$('*').prop('disabled',false);
  ...
  $('button#submitButton1').click(function(x) {
    var userInputs = {
      textInput1:$('#text-input1').val(),
      textInput2:$('#text-input2').val(),
      textInput3:$('#text-input3').val(),
